...
import old.core.graph.stash.Stash;
...
public class CoreGraph extends old.core.graph.AbstractGraph {
	...
	public MissionState missionState(String worldId, String missionId, String playerId) {
		return create(Stash.MissionsState.name()).missionState(worldId, missionId, playerId, old.core.model.attributes.MissionState.Pending.name());
	}
